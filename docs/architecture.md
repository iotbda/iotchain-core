...
Two slightly-obscurely-named components are:
  ...
  - ICP -- "IOTChain Consensus Protocol", the component implementing the
    [consensus algorithm](https://iotbdalliance.com/papers/iotchain-consensus-protocol.pdf).
...
- Set of core validator nodes. Running iotchain-core only. Tasked with:
...
- Set of public HTTP nodes. Not running iotchain-core. Running
...
- (optional): Set of public validator nodes. Running iotchain-core only. Tasked
with:
  ...
  - Basically just a iotchain-network load balancer / firewall for public access,
