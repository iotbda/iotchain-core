...
* `ICP` - protocol - make timing out of the ballot counters less aggressive (reduce overall ICP time to close a ledger).
...
* `ICP` - protocol - adjustments based on the whitepaper updates as of November 2015
