...
- **Ledger**: A ledger is the state of the distributed IOTChain database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/IOTChain-ledger.x`](/src/xdr/IOTChain-ledger.x))


`IOTChain-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `iotchain-core` can be configured to upload detailed historical
