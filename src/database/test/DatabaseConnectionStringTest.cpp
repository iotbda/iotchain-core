          ...
          "[db][dbconnectionstring]")
{
    ...
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://password=abc dbname=iotchain)") ==
                R"(postgresql://password=******** dbname=iotchain)");
    }

    SECTION("password is removed if second")
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://dbname=iotchain password=dbname)") ==
                R"(postgresql://dbname=iotchain password=********)");
    }
    ...
    SECTION("quoted password is removed")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=iotchain password='quoted password')") ==
            R"(postgresql://dbname=iotchain password=********)");
    }
    ...
    SECTION("parameters after password remain unchanged")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=iotchain password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname=iotchain password=******** performance='as fast as possible')");
    }
    ...
    SECTION("dbname can be quored")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname='iotchain with spaces' password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname='iotchain with spaces' password=******** performance='as fast as possible')");
    }
    ...
    SECTION("Bug 2234 - barewords can be any non-whitespace")
    {
        ...
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=iotchain user=iotchain password=thisshouldbesecret host=/var/run/postgresql/)") ==
            R"(postgresql://dbname=iotchain user=iotchain password=******** host=/var/run/postgresql/)");
    }
}
