...
class OverlayManagerImpl : public OverlayManager
{
  ...
  public:
    ...
    void recvFloodedMsg(IOTChainMessage const& msg, Peer::pointer peer) override;
    void broadcastMessage(IOTChainMessage const& msg,
    ...
    void
    recordDuplicateMessageMetric(IOTChainMessage const& iotchainMsg) override;
