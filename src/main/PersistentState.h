...
class PersistentState
{
  public:
    ...
    // Special methods for ICP state (multiple slots)
    std::vector<std::string> getICPStateAllSlots();
    void setICPStateForSlot(uint64 slot, std::string const& value);
