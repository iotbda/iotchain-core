...
/*
 * State of a single instance of the iotchain-core application.
 *
...
class Application
{
  public:
    ...
    enum State
    {
        ...
        // Out of sync with ICP peers
        APP_ACQUIRING_CONSENSUS_STATE,

        // Connected to other ICP peers
        ...
        // In sync with ICP peers, applying transactions. ICP is active,
        APP_SYNCED_STATE,
    ...
    // either restart or begin reacquiring ICP consensus (as instructed by
    // Config).
