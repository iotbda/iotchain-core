...
{
    Config c;
    c.load("testdata/iotchain-core_example_validators.cfg");
...
TEST_CASE("load example configs", "[config]")
{
    ...
    std::vector<std::string> testFiles = {
        "iotchain-core_example.cfg", "iotchain-core_standalone.cfg",
        "iotchain-core_testnet_legacy.cfg", "iotchain-core_testnet.cfg"};
