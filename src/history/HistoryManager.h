 ...
 * stored at .well-known/iotchain-history.json as a JSON file.
 *
 ...
 *
 * While the _most recent_ checkpoint is in .well-known/iotchain-history.json,
 ...
 * LedgerManager (::mSyncingLedgers) and extended as ICP hears of new closes,
...
class HistoryManager
{
  public:
    ...
    // Infer a quorum set by reading ICP messages in history archives.
