...
{
size_t
hash<iotchain::PublicKey>::operator()(iotchain::PublicKey const& k) const noexcept
{
    assert(k.type() == iotchain::PUBLIC_KEY_TYPE_ED25519);

    return std::hash<iotchain::uint256>()(k.ed25519());
}
}
