 ...
 * and auxiliary values -- as decided by the Herder (and ultimately: ICP). This
...
class LedgerCloseData
{
  ...
  private:
    ...
    IOTChainValue mValue;
};

std::string iotchainValueToString(Config const& c, IOTChainValue const& sv);
