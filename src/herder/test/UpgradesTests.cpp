...
executeUpgrades(Application& app, xdr::xvector<UpgradeType, 6> const& upgrades)
{
    ...
    IOTChainValue sv{txSet->getContentsHash(), 2, upgrades, IOTCHAIN_VALUE_BASIC};
                 ...
                 bool shouldListAny)
{
    ...
    header.icpValue.closeTime = VirtualClock::to_time_t(genesis(0, 0));
                     ...
                     bool canBeValid)
{
    ...
    baseLH.icpValue.closeTime = checkTime;
