...
closeLedger(Application& app)
{
    ...
    IOTChainValue sv(txSet->getContentsHash(), lcl.header.icpValue.closeTime,
          ...
          "[bucket][bucketmanager]")
{
    ...
    cfg.ARTIFICIALLY_PESSIMIZE_MERGES_FOR_TESTING = true;
    iotchain::historytestutils::TmpDirHistoryConfigurator tcfg;
...
{
    std::vector<iotchain::LedgerKey> emptySet;
    std::vector<iotchain::LedgerEntry> emptySetEntry;
