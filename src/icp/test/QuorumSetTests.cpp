...
TEST_CASE("sane quorum set", "[icp][quorumset]")
{
    ...
    auto check = [&](ICPQuorumSet const& qSetCheck, bool expected,
                     ICPQuorumSet const& expectedSelfQSet) {
    ...
    auto validMultipleNodes = ICPQuorumSet{};
    ...
    auto validMultipleNodesNormalized = ICPQuorumSet{};
    ...
    SECTION("{ t: 1, { t: 1, v0, { t: 1, v1 }, { t: 1, v2, v3 } } } -> { t:1, "
            "v0, v1, { t: 1, v2, v3 } }")
    {
        auto containingSet = ICPQuorumSet{};
